...
def search(query):
    ...
    string = ""
    for book in books:
        string += result % { "isbn": book.get("isbn"), "imgsrc": book.get("largeimageurl"), "title": book.get("title"), "author": book.get("authors"), "price": book.get("price"), "rank": book.get("salesrank") }
